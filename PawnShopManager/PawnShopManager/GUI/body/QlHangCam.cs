...
#region Event
      ...
      private void btnHienThiThongTin_Click(object sender, EventArgs e)
      {
         ...
         _tienLai_Chuoc = Util.UtilCommon.tinhTienLai(_hd.ngayTao, ngayChuoc, _hd.tienCam, _hd.laiSuatThoaThuan, _hd.laiSuatQuaHan, _hd.thoiHan);
      ...
      private void btnHoanThanhDongLai_Click(object sender, EventArgs e)
      {
         ...
         double[] tienLaiHienTai = UtilCommon.tinhTienLai(_hd.ngayTao, ngayMuonTraLai, _hd.tienCam, _hd.laiSuatThoaThuan, _hd.laiSuatQuaHan, _hd.thoiHan);
      ...
      private void dateTimeInputNgayChuoc_ChuocDo_ValueChanged(object sender, EventArgs e)
      {
         ...
         DateTime ngayChuoc = dateTimeInputNgayChuoc_ChuocDo.Value;
         _tienLai_Chuoc = UtilCommon.tinhTienLai(_hd.ngayTao, ngayChuoc, _hd.tienCam, _hd.laiSuatThoaThuan, _hd.laiSuatQuaHan, _hd.thoiHan);
      ...
      private void dateTimeInputNgayThanhLy_ThanhLy_ValueChanged(object sender, EventArgs e)
      {
         ...
         DateTime ngayThanhLy = dateTimeInputNgayThanhLy_ThanhLy.Value;
         _tienLai_ThanhLy = UtilCommon.tinhTienLai(_hd.ngayTao, ngayThanhLy, _hd.tienCam, _hd.laiSuatThoaThuan, _hd.laiSuatQuaHan, _hd.thoiHan);
         updateChange_ThanhLy();
      }
      #endregion
